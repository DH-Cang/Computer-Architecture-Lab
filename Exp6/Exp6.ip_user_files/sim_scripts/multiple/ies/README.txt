...
#
# Generated by export_simulation on Sun Dec 19 15:29:18 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './multiple.sh' script.

./multiple.sh -reset_run
...
./multiple.sh -noclean_files

For more information on the script, please type './multiple.sh -help'.
