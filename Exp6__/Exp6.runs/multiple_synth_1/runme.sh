...
HD_PWD='d:/Users/lenovo/Desktop/debugzju/nightmare/architecture/lab/Computer-Architecture-Lab/Exp6/Exp6.runs/multiple_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiple.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiple.tcl
